		...
		<div class="modal-content shadow p-5 rounded text-center">
			...
			<form action="edit.php" method="get" id="add_new_form" autocomplete="off">
				...
				<div class="progress progress-bar mb-3 d-none" id="progress-bar-multi-links">
					<div id="progress-loading" style="height: 100%" class="progress-bar progress-bar-striped progress-bar-animated progress-bar-purple" role="progressbar"
...
<script>
	jQuery(document).ready(function() {
		...
		var quill_options = {theme: 'snow', placeholder: 'Enter a description', modules: {toolbar: toolbarOptions, clipboard: {matchVisual: false}}};
